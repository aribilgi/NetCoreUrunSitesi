...
namespace Entities
{
    public class Contact : IEntity
    {
        ...
        [Display(Name = "Ad"), StringLength(50), Required(ErrorMessage = "Boş Geçilemez!")]
        public string? Name { get; set; }
        [Display(Name = "Soyad"), StringLength(50), Required(ErrorMessage = "Boş Geçilemez!")]
        public string? Surname { get; set; }
        [StringLength(50)]
        public string? Email { get; set; }
        [Display(Name = "Telefon"), StringLength(15)]
        public string? Phone { get; set; }
        [Display(Name = "Mesaj"), Required(ErrorMessage = "Boş Geçilemez!")]
